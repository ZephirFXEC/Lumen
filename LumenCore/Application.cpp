...
auto initializeDevice(RTCDevice device) -> RTCDevice {
...
namespace Lumen {
    ...
    auto Application::GetInstance() -> VkInstance {
        return g_Instance;
    }

    auto Application::GetPhysicalDevice() -> VkPhysicalDevice {
        return g_PhysicalDevice;
    }

    auto Application::GetDevice() -> VkDevice {
        return g_Device;
    }
