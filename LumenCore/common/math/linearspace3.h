...
namespace embree {
    ...
    struct LinearSpace3 {
        ...
        __forceinline LinearSpace3(const QuaternionT<Scalar> &q)
                : vx((q.r * q.r + q.i * q.i - q.j * q.j - q.k * q.k), 2.0f * (q.i * q.j + q.r * q.k),
                  ...
                  vy(2.0f * (q.i * q.j - q.r * q.k), (q.r * q.r - q.i * q.i + q.j * q.j - q.k * q.k),
                     2.0f * (q.j * q.k + q.r * q.i)), vz(2.0f * (q.i * q.k + q.r * q.j), 2.0f * (q.j * q.k - q.r * q.i),
        ...
        __forceinline const LinearSpace3 adjoint() const {
        ...
        __forceinline const LinearSpace3 transposed() const {
    ...
    template<typename T>
    __forceinline LinearSpace3<T> operator-(const LinearSpace3<T> &a) { return LinearSpace3<T>(-a.vx, -a.vy, -a.vz); }

    template<typename T>
    __forceinline LinearSpace3<T> operator+(const LinearSpace3<T> &a) { return LinearSpace3<T>(+a.vx, +a.vy, +a.vz); }

    template<typename T>
    __forceinline LinearSpace3<T> rcp(const LinearSpace3<T> &a) { return a.inverse(); }
    ...
    template<typename T>
    __forceinline LinearSpace3<T> operator/(const LinearSpace3<T> &a, const LinearSpace3<T> &b) { return a * rcp(b); }

    template<typename T>
    __forceinline LinearSpace3<T> &operator*=(LinearSpace3<T> &a, const LinearSpace3<T> &b) { return a = a * b; }
    ...
    template<typename T>
    __forceinline T xfmNormal(const LinearSpace3<T> &s, const T &a) { return xfmVector(s.inverse().transposed(), a); }
    ...
    template<typename T>
    __forceinline LinearSpace3<T>
    select(const typename T::Scalar::Bool &s, const LinearSpace3<T> &t, const LinearSpace3<T> &f) {
