...
namespace embree {
    ...
    __forceinline Vec3ia srl(const Vec3ia &a, const int b) {
        return Vec3ia(unsigned(a.x) >> b, unsigned(a.y) >> b, unsigned(a.z) >> b);
    }
...
*/
    ...
    __forceinline Vec3ia min(const Vec3ia &a, const Vec3ia &b) {
        return Vec3ia(sycl::min(a.x, b.x), sycl::min(a.y, b.y), sycl::min(a.z, b.z));
    }

    __forceinline Vec3ia max(const Vec3ia &a, const Vec3ia &b) {
        return Vec3ia(sycl::max(a.x, b.x), sycl::max(a.y, b.y), sycl::max(a.z, b.z));
    }
