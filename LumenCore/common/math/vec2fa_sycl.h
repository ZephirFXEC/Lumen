...
namespace embree {
    ...
    struct __aligned(16) Vec2fa {
        ...
        __forceinline Vec2fa(const Vec2fa &other) {
            x = other.x;
            y = other.y;
        }
    ...
    __forceinline Vec2fa rcp(const Vec2fa &a) {
        return Vec2fa(__sycl_std::__invoke_native_recip<float>(a.x), __sycl_std::__invoke_native_recip<float>(a.y));
    }
