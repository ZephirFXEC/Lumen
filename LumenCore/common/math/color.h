...
namespace embree {
    ...
    struct Color4 {
        ...
        __forceinline Color4(const float r, const float g, const float b, const float a) : m128(
                _mm_set_ps(a, b, g, r)) {}

        __forceinline explicit Color4(const Col3uc &other) {
            m128 = _mm_mul_ps(_mm_set_ps(255.0f, other.b, other.g, other.r), _mm_set1_ps(one_over_255));
        }

        __forceinline explicit Color4(const Col3f &other) { m128 = _mm_set_ps(1.0f, other.b, other.g, other.r); }

        __forceinline explicit Color4(const Col4uc &other) {
            m128 = _mm_mul_ps(_mm_set_ps(other.a, other.b, other.g, other.r), _mm_set1_ps(one_over_255));
        }
...
#endif
        return _mm_add_ps(r, _mm_mul_ps(r, _mm_sub_ps(_mm_set1_ps(1.0f),
    ...
    __forceinline const Color select(bool s, const Color &t, const Color &f) {
        __m128 mask = s ? _mm_castsi128_ps(_mm_cmpeq_epi32(_mm_setzero_si128(), _mm_setzero_si128()))
                        : _mm_setzero_ps();
