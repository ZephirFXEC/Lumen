...
namespace embree {
    ...
    struct mem<vfloat4> {
        ...
        static __forceinline void store(const vboolf4 &mask, void *ptr, const vfloat4 &v) {
            vfloat4::store(mask, ptr, v);
        }

        static __forceinline void storeu(const vboolf4 &mask, void *ptr, const vfloat4 &v) {
            vfloat4::storeu(mask, ptr, v);
        }
    };
...
#if defined(__AVX2__)
        return _mm_fmadd_ps(r, _mm_fnmadd_ps(a, r, vfloat4(1.0f)),
...
#if defined(__AVX2__)
        r = _mm_fmadd_ps(_mm_set1_ps(1.5f), r,
    ...
    template<int i>
    __forceinline float extract(const vfloat4 &a) { return _mm_cvtss_f32(shuffle<i>(a)); }

    template<>
    __forceinline float extract<0>(const vfloat4 &a) { return _mm_cvtss_f32(a); }
    ...
    __forceinline void
    transpose(const vfloat4 &r0, const vfloat4 &r1, const vfloat4 &r2, const vfloat4 &r3, vfloat4 &c0, vfloat4 &c1,
              vfloat4 &c2, vfloat4 &c3) {
